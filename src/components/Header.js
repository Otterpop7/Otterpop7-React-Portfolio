    ...
    <section>
      ...
      {page === 1 && (
        ...
        <div className="flex-container container">
          ...
          <div className="row">
            <div className="col-3">
              <img src={picture} alt="profile picture" style={{borderRadius: "50px"}}></img>
            </div>
            <div className="col-9">
              <h3 className="font">
        ...
        <div className="container">
          <div className="row">
            <div className="col-md-4">
              ...
              ></img>
              <h5 className="font">
                Crypto-Checker is a website for those interested in
                CryptoCurrency and various alternatives to central bank
                controlled fiat monies. It allows its user's to check the prices
                of crypto via search and also shows the user the top 8 most
                valuable crypto on the market at the given time.
              </h5>
              <p>
                <a
            ...
            <div className="col-md-4">
              ...
              <h5 className="font">
                ...
                streamline and visualize the user's sensitive budget through
                user created categories. Bootstrap has been used to make the
            ...
            <div className="col-md-4">
              ...
              ></img>
              <h5 className="font">
                Tech Blog is a project of mine that allows you to add posts and
                comments and login just like you would on a blog website.
              </h5>
              <p>
                <a
                  className="btn btn-secondary font"
            ...
            <div className="col-md-4">
              ...
              ></img>
              <h5 className="font">
                Note Taker is an app that allows you to create notes and save
                them to a local storage. It is a nice app if you want to take
                some simple notes and save them and delete them when you don't
                need them anymore.
              </h5>
              <p>
                <a
            ...
            <div className="col-md-4">
              ...
              ></img>
              <h5 className="font">
                This is a workday scheduler on which you can write a task and
                save the task by clicking the save icon. It utilizes a local
                storage so that when you refresh the page it keeps your tasks.
                It also tells you past present and future tasks, past being
                grey, present being red, and future being green.
              </h5>
              <p>
                <a
                  className="btn btn-secondary font"
      ...
      { page === 3 && <div className="flex-container container">
          <>
          <div className="d-inline-block"></div>
        ...
        <div className="row">
          ...
          <div className="col-4">
            <h3 className="font">
              Email Address: &nbsp;&nbsp; Jordanotterson7@gmail.com
            </h3>
          </div>
        </div>
        <div className="d-inline-block"></div>
